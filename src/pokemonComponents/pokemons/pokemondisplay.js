      ...
      <div key={id}>
        ...
        <Row>
          ...
          <img className = 'pokesprite' alt = "Whos that Pokemon?"
            ...
            <button id={props.pokemonteam[id].id} onClick={props.update1} className='buttonblue' > <img className = 'pokeball'
                    src={pokeball}/> <b>Capture</b> </button>
            </Col>
          ...
          <img className = 'pokesprite' alt = "Whos that Pokemon?"
            ...
            <button id={props.pokemonteam[id].id} onClick={props.update2} className='buttonblue' > <img className = 'pokeball'
                    src={pokeball}/> <b>Capture</b> </button>
            </Col>
          ...
          <button id={props.pokemonteam[id].id} onClick={props.update3} className='buttonblue' ><img className = 'pokeball'
                    src={pokeball}/> <b>Capture</b> </button>
          </Col>
        ...
        <Col className = 'pokeslot' md="4">
          ...
          <img className = 'pokesprite' alt = "Whos that Pokemon?"
            ...
            <button id={props.pokemonteam[id].id} onClick={props.update4} className='buttonblue' ><img className = 'pokeball'
                    src={pokeball}/> <b>Capture</b> </button>
          </Col>
          ...
          <img className = 'pokesprite' alt = "Whos that Pokemon?"
            ...
            <button id={props.pokemonteam[id].id} onClick={props.update5} className='buttonblue' ><img className = 'pokeball'
                    src={pokeball}/> <b>Capture</b> </button>
          </Col>
          ...
          <img className = 'pokesprite' alt = "Whos that Pokemon?"
            ...
            <button id={props.pokemonteam[id].id} onClick={props.update6} className='buttonblue' ><img className = 'pokeball'
                    src={pokeball}/> <b>Capture</b> </button>
          </Col>
